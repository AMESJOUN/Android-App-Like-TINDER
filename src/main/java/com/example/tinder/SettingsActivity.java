...
public class SettingsActivity extends AppCompatActivity {
    ...
    private EditText nNameField,mPhoneField;
        ...
        mCostumerDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(snapshot.exists() && snapshot.getChildrenCount()>0){
                    ...
                    if(map.get("profileImageuUrl")!= null){
                        profileImageUrl=map.get("profileImageuUrl").toString();
    ...
    private void saveUserInformation() {
        name = nNameField.getText().toString();
        ...
        if(resulturi != null){
            ...
            uploadtask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    Map userInfo =new HashMap();
                    userInfo.put("profileImageuUrl",downloadUrl.toString());
                    userInfo.put("phone",phone);
